    ...
    public User(JSONObject dico) {
        ...
        if (dico != null) {
            ...
            try {
                ...
                user_date = MyTools.sharedInstance().dateFromServer(dico.get("user_date").toString());
                ...
                user_newpassword = Integer.parseInt(dico.get("user_newpassword").toString()) != 0;
                user_tokenPush = dico.get("user_tokenPush").toString();
                user_device = dico.get("user_device").toString();
