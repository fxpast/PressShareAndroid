...
public class Product {
    ...
    private String  prod_nom; //stoker url de l'image
    ...
    private int  prod_by_cat; //le client
    ...
    private String  prod_tempsDispo;
    public String getProd_tempsDispo() { return prod_tempsDispo;}
    public void setProd_tempsDispo(String prod_tempsDispo) {this.prod_tempsDispo = prod_tempsDispo;}
    ...
    public Product(final Context context, JSONObject dico) {
        ...
        if (dico != null) {
            ...
            try {
                ...
                prod_date = MyTools.sharedInstance().dateFromString(dico.get("prod_date").toString(), "yyyy-MM-dd HH:mm:ss");
