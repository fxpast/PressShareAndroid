...
public class InfoWindow {
    ...
    /**
     * @param position The {@link LatLng} which determines the window's position on the screen.
     * @param markerSpec Provides the marker's offsetX and offsetY.
     * @param fragment The actual window that is displayed on the screen.
     */
    public InfoWindow(
    ...
    public static class MarkerSpecification implements Serializable {
         ...
         *
         * @see com.prv.pressshare.InfoWindowManager#centerInfoWindow(InfoWindow, android.view.View)
         */
