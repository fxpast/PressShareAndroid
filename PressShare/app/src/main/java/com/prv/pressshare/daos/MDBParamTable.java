...
public class MDBParamTable {

    private static MDBParamTable  mInstance;


    public void  getAllParamTables(final Context context, final MDBInterfaceArray completion) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.getUrlServer()+"api_getAllParamTables.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                if (success.equals("1")){
                    try {
                        JSONArray resultArray = (JSONArray) resultDico.get("allparamtables");
    ...
    public static MDBParamTable sharedInstance() {
        if (mInstance == null) {
            mInstance = new MDBParamTable();
        }
        return mInstance;
    }
